    ...
    <div class="container theme-showcase" role="main">
      ...
      <?php
		 ...
		 for($i = 1; $i <= 10; $i++){
			 ...
			 $flag = false;
			 for($j =1; $j <= 14; $j++){
				 if(($i==1 && $j == 11) || ($i>=2 && $i<=4 && $j==12) || ($i>=5 && $i<10 && $j==13) || ($i==10 && $j==14)){
				    echo "<br>";
					break;
				 }
				 else{
					...
					if(($i>=6 && $i<=9) && ($x==10 || $x==2)) echo "&nbsp;&nbsp;&nbsp;&nbsp;";
					if($f == false){
						if($i < 10){
							echo "<button type=\"button\" class=\"btn btn-success\" style=\"width:90px\" onClick=\"javascript:window.location.href='processbook.php?id=$movid&r=$i&c=$x'\">".$i."排".$x."座</button>";
						}
						else{
							echo "<button type=\"button\" class=\"btn btn-success\" style=\"width:86px\" onClick=\"javascript:window.location.href='processbook.php?id=$movid&r=$i&c=$x'\">".$i."排".$x."座</button>";
						}
					}
					else{
						if($i < 10){
							echo "<button type=\"button\" class=\"btn btn-danger\" style=\"width:90px\" disabled=\"true\">".$i."排".$x."座</button>";
						}
						else{
							echo "<button type=\"button\" class=\"btn btn-danger\" style=\"width:86px\" disabled=\"true\">".$i."排".$x."座</button>";
						}
					}
				 }
			 }
